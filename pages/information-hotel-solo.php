            ...
            <div class="col-md-3 col-sm-6">
              <div class="facility-card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Sajian kuliner autentik khas Bali dan menu internasional yang disiapkan oleh chef berbintang.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="gallery-card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Sambut kedatangan Anda dengan lobi megah berhiaskan ornamen batik, kilauan mega ala Bali dan ukiran-ukiran Bali dari kayu jati asli.</p>
                </div>
              </div>
            </div>
