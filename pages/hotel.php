  ...
  <main class="container py-5" style="max-width: 1000px;">
    ...
    <div class="d-flex flex-column gap-4 pb-5">
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden d-flex flex-row" style="height: 160px;">
        <img 
          src="https://content.r9cdn.net/rimg/himg/d7/e4/a9/expedia_group-118319-0079ab-448801.jpg?width=335&height=268&crop=true" 
          alt="villa-sonia-ubud"
        ...
        <div class="card-body d-flex flex-row p-0">
          <div class="d-flex flex-column justify-content-center px-4 flex-grow-1">
            <h5 class="fw-bold mb-1">Villa Sonia Ubud</h5>
          ...
          <div class="d-flex flex-column align-items-center justify-content-center px-4 gap-1" style="background-color: #f5f5f5; min-width: 150px; border-left: 1px solid #eee;">
            ...
            <p class="fw-bold mb-0" style="font-size: 22px;">Rp 750K</p>
            <p class="text-success mb-2" style="font-size: 11px;">Gratis Biaya Batal Booking</p>
            <a href="/tugas-uts-pweb/pages/information-hotel-sonia.php" class="btn btn-outline-dark w-100" style="font-size: 13px;">Detail</a>
          </div>
        </div>
      </div>
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden d-flex flex-row" style="height: 160px;">
        <img 
          src="https://www.kayak.com/rimg/himg/6c/9e/5f/expedia_group-3726321-86178039-943326.jpg?width=200&height=200&crop=true" 
          alt="arya-villas-ubud"
          style="width: 220px; object-fit: cover; flex-shrink: 0;"
        >
        <div class="card-body d-flex flex-row p-0">
          <div class="d-flex flex-column justify-content-center px-4 flex-grow-1">
            <h5 class="fw-bold mb-1">Arya Villas Ubud</h5>
            <p class="text-muted mb-2" style="font-size: 13px;">
              <i class="bi bi-geo-alt me-1"></i>Ubud, Bali, Indonesia
            </p>
            <div class="d-flex align-items-center gap-2 mb-2">
          ...
          <div class="d-flex flex-column align-items-center justify-content-center px-4 gap-1" style="background-color: #f5f5f5; min-width: 150px; border-left: 1px solid #eee;">
            <p class="text-muted mb-0" style="font-size: 11px;">Gratis Makan Pagi</p>
            <p class="fw-bold mb-0" style="font-size: 22px;">Rp 1.116K</p>
            <p class="text-success mb-2" style="font-size: 11px;">Gratis Biaya Batal Booking</p>
            <a href="/tugas-uts-pweb/pages/information-hotel-arya.php" class="btn btn-outline-dark w-100" style="font-size: 13px;">Detail</a>
          </div>
        </div>
      </div>
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden d-flex flex-row" style="height: 160px;">
        <img 
          src="https://www.kayak.com/rimg/himg/50/36/67/expedia_group-2732798-c9486e-334190.jpg?width=200&height=200&crop=true" 
          alt="solo-villas-and-retreat"
          style="width: 220px; object-fit: cover; flex-shrink: 0;"
        >
        <div class="card-body d-flex flex-row p-0">
          <div class="d-flex flex-column justify-content-center px-4 flex-grow-1">
